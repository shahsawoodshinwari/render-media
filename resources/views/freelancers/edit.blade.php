@extends('layouts.app', ['title' => 'Freelancers - Edit'])
  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="card-title">{{ __('Edit Freelancer Info') }}</h4>
        <a href="{{ route('freelancers.index') }}" class="btn btn-primary">{{ __('Back to List') }}</a>
      </div>
      <form action="{{ route('freelancers.update', $freelancer->id) }}" method="post" autocomplete="off">
        @csrf
        @method('PUT')
        <div class="row g-3">
          <!-- First Name -->
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-default bg-transparent @error('first_name') is-invalid @enderror" name="first_name" id="first_name" value="{{ old('first_name', $freelancer->first_name) }}" placeholder="{{ __('First Name') }}" />
              @error('first_name')
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-default bg-transparent @error('last_name') is-invalid @enderror" name="last_name" id="last_name" value="{{ old('last_name', $freelancer->last_name) }}" placeholder="{{ __('Last Name') }}" />
              @error('last_name')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control select2 input-default bg-transparent @error('speciality') is-invalid @enderror" name="speciality" id="speciality">
                ...
                <option <?php echo old('speciality', $freelancer->speciality) == $speciality->name ? 'selected' : ''; ?>>{{ $speciality->name }}</option>
                @endforeach
              </select>
              @error('speciality')
              <div class="invalid-feedback">{{ $message }}</div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" inputmode="numeric" step="1" min="1" class="form-control input-default bg-transparent @error('experience') is-invalid @enderror" name="experience" id="experience" value="{{ old('experience', $freelancer->experience) }}" placeholder="{{ __('Experience') }}" />
              @error('experience')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" inputmode="numeric" class="form-control input-default bg-transparent @error('phone') is-invalid @enderror" name="phone" id="phone" value="{{ old('phone', $freelancer->phone) }}" placeholder="{{ __('Phone') }}" />
              @error('phone')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="url" class="form-control input-default bg-transparent @error('portfolio') is-invalid @enderror" name="portfolio" id="portfolio" value="{{ old('portfolio', $freelancer->portfolio) }}" placeholder="{{ __('Portfolio') }}" />
              @error('portfolio')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
